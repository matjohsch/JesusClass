...
real(8), dimension(n,nGridProductivity) :: mValueFunction, mPolicyCapital, mPolicyConsumption, mPolicyLabour

open (unit = 1, file = 'policyfunction.txt', status = 'old')
do cOut = 1,n
   write (1,'(21f30.15)') vGridcapital(cOut),&
                          ...
                          mPolicyConsumption(cOut,1), mPolicyConsumption(cOut,2), mPolicyConsumption(cOut,3), mPolicyConsumption(cOut,4), mPolicyConsumption(cOut,5),  &
